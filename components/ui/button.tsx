...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 relative overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-[#FF5390] via-[#F5B341] to-[#68AF6B] text-white hover:opacity-90",
        destructive:
        ...
        gradient:
          "bg-gradient-to-r from-[#FF5390] via-[#F5B341] to-[#68AF6B] text-white hover:opacity-90",
        gradientOutline:
          "border border-transparent bg-gradient-to-r from-[#FF5390] via-[#F5B341] to-[#68AF6B] text-white hover:opacity-90 before:absolute before:inset-0 before:bg-white before:rounded-md before:opacity-0 hover:before:opacity-10",
      },
      size: {
